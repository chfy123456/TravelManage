...
<div id="middle">
	 ...
	 <!--  购物车 -->
	 <div id="product_info">
			<div class="title">个人中心  &gt;&gt;  我的收藏路线信息</div>
				 ...
				 <table class="ptable" style="margin-bottom:5px;">
				 	<tr>
						<td colspan="15" align="right">
							路线名称：
      						<input type="text" id="line_title" name="line_title" style=""
      							value="${paramsCollect.line_title}" class="inputstyle"/>&nbsp;
      					    <input type="button" value="搜索" onclick="serch();" class="btnstyle"/>&nbsp;
						</td>
					</tr>
					<tr class="head_text">
					     <td width="200" align="center">路线名称</td>
					  ...
					  <c:if test="${collects!=null &&  fn:length(collects)>0}">
					   ...
					   <tr> 
					     <td width="" align="center">
					     	<a href="page_queryLine.action?line_id=${collect.line_id}">
					     	${collect.line_title}
					     	</a>
					     </td>
