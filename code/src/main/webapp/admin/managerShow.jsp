...
function serch()
{
   document.info.action="Admin_listManagers.action";
...
function del()
{
    ...
    if(ids=="")
    {
       alert("请至少选择一个要删除的系统用户！");
       return false;
    }
    if(confirm('确认删除吗!?'))
    {
       document.info.action="Admin_delManagers.action?ids="+ids;
       document.info.submit();
    }
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">系统用户管理&gt;&gt;${user_typeDesc}查询</span>
</div>
<form name="info" id="info" action="Admin_listManagers.action" method="post">
...
<table width="95%"  class="table_top" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="" align="right">
      ...
      <input type="button" value="新增" onclick="window.location.href='Admin_addManagerShow.action?user_type=${user_type}';" class="btnstyle"/>&nbsp;
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="list0" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center">${fn:substring(user.reg_date,0,19)}&nbsp;</td>
     <td width="" align="center">
       <img src="images/edit.png"/>&nbsp;<a href="Admin_editManager.action?user_id=${user.user_id}&user_type=${user_type}">编辑</a>
     </td>
   </tr> 
  </c:forEach>
   </c:if>
   <c:if test="${users==null ||  fn:length(users)==0}">
   <tr>
     <td height="60" colspan="13" align="center"><b>&lt;不存在${user_typeDesc}信息&gt;</b></td>
   </tr>
  </c:if>
